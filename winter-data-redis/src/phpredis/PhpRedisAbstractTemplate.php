 ...
 * @method mixed exec()
 * @method mixed exists(string $key, array $other_keys = null)
 ...
 * @method mixed hDel(string $key, string $member, array $other_members = null)
 ...
 * @method mixed srem(string $key, string ...$member)
